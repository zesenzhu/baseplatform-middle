...
const AdjustByTeacherModal = (state={
    ...
    switch (actions.type) {
        ...
        case ABTActions.TEACHER_REPLACE_SHCEDULE_MONTHS_LOADING_HIDE:

            return { ...state,replaceSchedule:{...state.replaceSchedule,monthLoading:false} };
        ...
        case ABTActions.TEACHER_REPLACE_SHCEDULE_WEEKS_LOADING_HIDE:

            return { ...state,replaceSchedule:{...state.replaceSchedule,weekLoading:false}};
