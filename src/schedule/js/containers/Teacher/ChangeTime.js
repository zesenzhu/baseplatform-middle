            ...
            apiActions.GetWeekInfoByDate({SchoolID, ClassDate: dateString, dispatch}).then(data => {
                ...
                if (data) {
                    ...
                    let ClassHour = ClassHourList.map(item => {
                        ...
                        let titleWrapper = <span title={`第${item.ID}节 (${title})`}>第{item.ID}节 <span
                            className="noon">({title})</span></span>;
                    ...
                    dispatch({
                        type: ABTActions.CHANGE_TIME_NEW_CHANGE,
                        data: {type: "classHourListChange", value: ClassHour}
                    });
                }
            ...
            <div className="change-time-wrapper clearfix" ref={ref}>
                    ...
                    <div className="new-time-wrapper clearfix" style={{marginTop:12}}>
                        ...
                        <div className="content-wrapper">
                            ...
                            {/*<Tips  visible={targetClassRoomTips} title="请选择教室">
