...
function App(props) {
  ...
  const firstLoad = () => {
    ...
    if (targetUserID && targetUserType && [1, 2].includes(targetUserType)) {
      ...
      dispatch(
        targetUserInfoUpdate({ UserID: targetUserID, UserType: targetUserType })
      );
...
// console.log($.ajax("http://192.168.129.8:10103/WS_CJZP/api/JWCJZP/GetStudentReport?Term=1&XH=Stu007&SchoolID=S-888")
// )
  return (
