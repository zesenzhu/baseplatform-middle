  ...
  const btnClick = useCallback((tName) => {
    ...
    if (UserType === 2) {
      window.open(
        `${removeSlashUrl(
          url
        )}/index_user.html?lg_tk=${token}&stuId=${UserID}&lg_ic=${lg_ic}#3|1|0`
      );
    } else {
      if (["AdmToTeacher", "LeaderToTeacher"].includes(UsedType)) {
        window.open(
          `${removeSlashUrl(
            url
          )}/index_user.html?lg_tk=${token}&tName=${tName}&tId=${UserID}&lg_ic=${lg_ic}#1|4|0`
        );
      } else {
        window.open(
          `${removeSlashUrl(
            url
          )}/index_user.html?lg_tk=${token}&lg_ic=${lg_ic}#5|3|0`
        );
      }
    }
  }, []);
  ...
  const tableDom = useMemo(() => {
    ...
    if (userStatus.ready) {
      if (userStatus.receiveData) {
            ...
            <div className={"archives-table stu"}>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className={"col2"}>
                      <div
                        className={"user-name"}
                        title={userStatus.studentStatus[0].userName}
                      >
                    ...
                    <td className={"col4"}>
                      <div
                        className={"former-name"}
                        title={userStatus.studentStatus[0].formerName}
                      >
                    ...
                    <td className={"col7"} rowSpan={6}>
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${userStatus.studentStatus[0].photoPath})`,
                        }}
                      ></div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className={"col2"}>
                      {isHasValue(userStatus.studentStatus[0].birthDay)}
                    </td>

                    <td className={"col3 props"}>性别</td>

                    <td className={"col4"}>
                      {isHasValue(userStatus.studentStatus[0].sex)}
                    </td>

                    <td className={"col5 props"}>民族</td>

                    <td className={"col6"}>
                      {isHasValue(userStatus.studentStatus[0].nation)}
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className={"col6"} colSpan={2}>
                      {isHasValue(userArchives ? userArchives.GradeName : "")}
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className={"col2"} colSpan={2}>
                      <div
                        ...
                        title={userStatus.studentStatus[0].className}
                      >
                      ...
                      <div className={"genger"}>
                        {userArchives && userArchives.Ganger ? (
                          <Button
                            ...
                            type={"link"}
                            className={"genger-btn"}
                            title={userArchives.GangerName}
                          >
                  ...
                  <tr>
                    ...
                    <td className={"col2"}>
                      <div
                        className={"country"}
                        title={userStatus.studentStatus[0].country}
                      >
                    ...
                    <td className={"col4"}>
                      <div
                        className={"native-space"}
                        title={userStatus.studentStatus[0].nativeSpace}
                      >
                    ...
                    <td className={"col6"}>
                      {isHasValue(userStatus.studentStatus[0].overseaPeople)}
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className={"col2"}>
                      {isHasValue(userStatus.studentStatus[0].singleChild)}
                    </td>

                    <td className={"col3 props"}>是否受过学前教育</td>
                    <td className={"col4"}>
                      {isHasValue(userStatus.studentStatus[0].preschoolEdu)}
                    </td>
                    <td className={"col5 props"}>是否留守儿童</td>
                    <td className={"col6"}>
                      {isHasValue(userStatus.studentStatus[0].leftoverChild)}
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className={"col2"}>
                      <div
                        className={"census-place"}
                        title={userStatus.studentStatus[0].censusPlace}
                      >
                    ...
                    <td className={"col4"} colSpan={4}>
                      <div
                        ...
                        title={userStatus.studentStatus[0].homeAddress}
                      >
              ...
              <table className={"tb2"} border="1">
                <tbody>
                  <tr>
                    <td
                      className={"col1 props"}
                      rowSpan={
                        userStatus.resume && userStatus.resume.length > 0
                          ? userStatus.resume.length + 1
                          : 2
                      }
                    >
                      学习经历
                  ...
                  {userStatus.resume && userStatus.resume.length > 0 ? (
                    userStatus.resume.map((i, k) => {
                      return (
                        <tr key={i.id}>
                          <td className={"col2"}>
                            {isHasValue(i.semesterStartTime)}
                          </td>
                          <td className={"col3"}>
                            {isHasValue(i.semesterEndTime)}
                          </td>
                          <td className={"col4"}>
                            <div className={"school-name"} title={i.school}>
                              {isHasValue(i.school)}
                            </div>
                          </td>
                          <td className={"col5"}>
                            <div
                              ...
                              title={i.learningContent}
                            >
                              {isHasValue(i.learningContent)}
                            </div>
                          </td>
                          <td className={"col6"}>
                            <div className={"duty"} title={i.duty}>
                              {isHasValue(i.duty)}
                            </div>
                          </td>
                          <td className={"col7"}>
                            <div className={"certifier"} title={i.certifier}>
                              {isHasValue(i.certifier)}
                            </div>
                          </td>
                        </tr>
                      );
                  ...
                  {userStatus.guardian && userStatus.guardian.length > 0 ? (
                    userStatus.guardian.map((i, k) => {
                      return (
                        <tr key={i.id}>
                          <td className={"col2"}>
                            <div className={"name"} title={i.name}>
                              {isHasValue(i.name)}
                            </div>
                          </td>
                          <td className={"col3"}>
                            {isHasValue(i.relationship)}
                          </td>
                          <td className={"col4"}>
                            <div
              ...
              <table className={"tb1"} border="1">
                <tbody>
                  <tr>
                    ...
                    <td className={"col6"}>
                      {isHasValue(userArchives.Gender)}
                    </td>
                  ...
                  <tr>
                    ...
                    <td className={"col4"}>
                      {isHasValue(userStatus.professionalTitle)}
                    </td>
                  ...
                  <tr>
                    ...
                    <td className={"col4"} colSpan={2}>
                      <div
                        className={"politic-status"}
                        title={userStatus.politicStatus}
                      >
                  ...
                  <tr>
                    ...
                    <td className={"col4"} colSpan={2}>
                      {isHasValue(userStatus.educationBackground)}
                    </td>
                  </tr>
                    ...
                    <td className={"col2"} colSpan={6}>
                      {userStatus.workExperience ? (
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: userStatus.workExperience,
                          }}
                        ></div>
                      ) : (
        ...
        const { ProductUseRange } = JSON.parse(
        ...
        if (UserType === 2) {
          ...
          return (
            <div className={"archives-table no-data stu"}>
              <table
                className={`tb1 ${environ === 0 ? "middle" : ""}`}
                border="1"
              >
                <tbody>
                  <tr>
                    ...
                    <td className={"col7"} rowSpan={environ === 0 ? 4 : 5}>
                      <div
                        className={"user-photo"}
                        style={{
                          backgroundImage: `url(${userArchives.PhotoPath})`,
                        }}
                      ></div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className={"col2"}>
                      <div
                        ...
                        title={isHasValue(userArchives.GradeName)}
                      >
                        {isHasValue(userArchives.GradeName)}
                      </div>
                    </td>
                    ...
                    <td className={"col4"}>
                      <div
                        className={"class-name"}
                        title={isHasValue(userArchives.ClassName)}
                      >
                        {" "}
                    ...
                    <tr>
                      ...
                      <td className={"col2"} colSpan={2}>
                        <div
                          ...
                          title={isHasValue(userArchives.CollegeName)}
                        >
                          {isHasValue(userArchives.CollegeName)}
                        </div>
                      </td>
                      ...
                      <td className={"col5"} colSpan={2}>
                        <div
                          ...
                          title={isHasValue(userArchives.MajorName)}
                        >
                          {isHasValue(userArchives.MajorName)}
                        </div>
                      </td>
                    </tr>
                  ) : null}
                  ...
                  <tr>
                    ...
                    <td className={"col5"} colSpan={2}>
                      <div
                        className={"home-address"}
                        title={userArchives.HomeAddress}
                      >
          ...
          return (
            <div className={"archives-table no-data teacher"}>
              <table
                className={`tb1 ${environ === 0 ? "middle" : ""}`}
                border="1"
              >
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className={"col4"}>
                      {isHasValue(userArchives.TitleName)}
                    </td>
                  ...
                  {environ === 1 ? (
                    <tr>
                      ...
                      <td className={"col4"} colSpan={3}>
                        <div
                          className={"teaching-room"}
                          title={isHasValue(userArchives.GroupName)}
                        >
                          {isHasValue(userArchives.GroupName)}
                        </div>
                      </td>
                    </tr>
                  ) : null}
        ...
        <div className={"btn-wrapper clearfix"}>
          {BaseData.ProductType === 3 && Urls["L10"].WebUrl ? (
            <LinkBtn onClick={(e) => toGrow()} type={"details"}>
              ...
              "TeacherToTeacher",
              "LeaderToTeacher",
            ].includes(UsedType) && userStatus.receiveData ? (
            <LinkBtn
              onClick={(e) =>
                btnClick(UserType === 1 ? userStatus.userName : "")
              }
              type={"archives"}
            >
              档案信息管理
