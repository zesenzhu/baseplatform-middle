...
import { GetSubjectCouseclassSumarry_Middle } from '../../../../actions/apiActions';

import {logCountUpdate} from "../../../../reducers/commonSetting";

import {subjectBreadCrumbChange,breadCrumbInit} from "../../../../reducers/breadCrumb";
...
function SubjectTotal(props) {
    ...
    const tabClick = ({CardID,CardName}) =>{
        ...
        dispatch(subjectBreadCrumbChange({subjectID:CardID,subjectName:CardName}));

        history.push(`/statics/subject/${CardID}`);
    ...
    return(
        ...
        <Loading spinning={loading} tip={"加载中,请稍候..."}>
            ...
            <div className={"teacher-total-wrapper"}>
                ...
                <TitleBar type={"course"} title={"学科教师教学班统计"}></TitleBar>

                <StaticsCircle list={staticsList}></StaticsCircle>

                <CardTab tabClick={tabClick} type={4} list={cardList}></CardTab>
...
export default memo(SubjectTotal);
