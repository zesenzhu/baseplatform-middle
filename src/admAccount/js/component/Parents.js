...
class Parents extends React.Component {
  ...
  OnCheckAllChange = e => {
    ...
    if (e.target.checked) {
      this.setState({
        checkedList: DataState.ParentsPreview.keyList,
  ...
  onCheckBoxGroupChange = checkedList => {
    ...
    this.setState({
      checkedList,
      checkAll:
        checkedList.length === DataState.ParentsPreview.keyList.length
          ? true
          : false
    });
  };
  ...
  onAllPwdchangeOk = pwd => {
    ...
    if (this.state.defaultPwd === "") {
      ...
      let userIDs = this.state.checkedList.map((child, index) => {
        return DataState.ParentsPreview.newList[child].Others.UserID;
      });
      postData(
        CONFIG.UserAccountProxy + url,
        {
            ...
            <div className="content-render">
              ...
              >
                <div>
                  ...
                  >
                    {DataState.ParentsPreview.newList instanceof Array &&
                    DataState.ParentsPreview.newList.length !== 0 ? (
                      <Table
                        className="table"
                        ...
                        dataSource={DataState.ParentsPreview.newList}
                      ></Table>
                    ) : (
                      <Empty
                        title={
                  ...
                  {DataState.ParentsPreview.Total ? (
                    <div style={{ display: "inline-block" }}>
                      <CheckBox
                        style={{
                          display:
                            DataState.ParentsPreview.Total === 0
                              ? "none"
                              : "inline-block"
                        }}
          ...
          title={
            this.state.ChangePwdMadalVisible ? (
              <p className="alert-Title">
                ...
                <span
                  title={
                    DataState.ParentsPreview.newList[this.state.onClickKey]
                      .UserName.Name
                  }
