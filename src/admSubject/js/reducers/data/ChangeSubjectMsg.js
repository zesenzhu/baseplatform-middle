...
function handleData(data) {
  let GlobalGradeIDs = handleGrade(data.P1Grade)
    .concat(handleGrade(data.P2Grade))
    .concat(handleGrade(data.P3Grade))
    .concat(handleGrade(data.MGrade))
    .concat(handleGrade(data.OGrade))
    .concat(handleGrade(data.KGrade))
    .join();
...
function handleGrade(grade) {
  let endGrade = "";
  let gradeArr1 =typeof grade ==='string'? grade.split(","):[];
