...
import Pubilc from "../../../common/js/public";
let { getQueryVariable } = Pubilc;
  ...
  constructor(props) {
    ...
    TokenCheck_Connect(false, () => {
      ...
      if (sessionStorage.getItem("UserInfo")) {
        // let SubjectId =JSON.parse(sessionStorage.getItem("UserInfo")).SubjectId
        let SubjectId = getQueryVariable("subjectID")
          ? getQueryVariable("subjectID")
          : "";
        ...
        let timerID = setInterval(() => {
          if (sessionStorage.getItem("UserInfo")) {
            if (
              JSON.parse(sessionStorage.getItem("UserInfo")).UserType !== "1"
            ) {
